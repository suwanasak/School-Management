...
namespace SchoolMangementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=OKF_MOBILE49\SQLEXPRESS;Initial Catalog=POS;User ID=Lui;Password=sa;TrustServerCertificate=True;Connect Timeout=30");
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"D:\Github\School-Management\SchoolMangementSystem\SchoolMangementSystem\Teacher_Directory\", teacher_id.Text.Trim() + ".jpg");
